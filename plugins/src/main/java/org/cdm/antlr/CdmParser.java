...
public class CdmParser extends Parser {
	...
	public static final int
		...
		RULE_line = 14, RULE_labels_declaration = 15, RULE_labels = 16, RULE_arguments = 17, 
		RULE_conditional = 18, RULE_conditions = 19, RULE_connective_condition = 20, 
		RULE_condition = 21, RULE_else_clause = 22, RULE_branch_mnemonic = 23, 
		RULE_conjunction = 24, RULE_while_loop = 25, RULE_while_condition = 26, 
		RULE_until_loop = 27, RULE_argument = 28, RULE_byte_expr = 29, RULE_addr_expr = 30, 
		RULE_first_term = 31, RULE_add_term = 32, RULE_term = 33, RULE_byte_specifier = 34, 
		RULE_label = 35, RULE_instruction = 36, RULE_string = 37, RULE_register = 38, 
		RULE_character = 39, RULE_number = 40, RULE_name = 41;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"labels_declaration", "labels", "arguments", "conditional", "conditions", 
			"connective_condition", "condition", "else_clause", "branch_mnemonic", 
	...
	public final Line_markContext line_mark() throws RecognitionException {
		...
		try {
			...
			self.current_line = int((((Line_markContext)_localctx).line_number!=null?_input.getText(((Line_markContext)_localctx).line_number.start,((Line_markContext)_localctx).line_number.stop):null))
			self.current_file =  b64decode((((Line_markContext)_localctx).filepath!=null?_input.getText(((Line_markContext)_localctx).filepath.start,((Line_markContext)_localctx).filepath.stop):null)[3:]).decode()
			_localctx.source_file = self.current_file
			_localctx.source_line = self.current_line
			self.current_offset = (((Line_markContext)_localctx).line_number!=null?(((Line_markContext)_localctx).line_number.start):null).line - self.current_line + 1
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Labels_declarationContext labels_declaration() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_labels_declaration);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final LabelsContext labels() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_labels);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Connective_conditionContext connective_condition() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_connective_condition);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Branch_mnemonicContext branch_mnemonic() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_branch_mnemonic);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(309);
	...
	public final While_conditionContext while_condition() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_while_condition);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(334);
	...
	public final Until_loopContext until_loop() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_until_loop);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Byte_exprContext byte_expr() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_byte_expr);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(357);
	...
	public final Addr_exprContext addr_expr() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_addr_expr);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final First_termContext first_term() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_first_term);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Add_termContext add_term() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_add_term);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Byte_specifierContext byte_specifier() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_byte_specifier);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(381);
	...
	public final RegisterContext register() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_register);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(389);
